...
void mainWindow::sort()
{
	...
	if (dialog.exec())
	{
		...
		compare.keys[0] = dialog.Getui().comboBox->currentIndex();
		compare.keys[1] = dialog.Getui().comboBox_3->currentIndex() - 1;
		compare.keys[2] = dialog.Getui().comboBox_5->currentIndex() - 1;
		compare.ascending[0] = (dialog.Getui().comboBox_2->currentIndex() == 0);
		compare.ascending[1] = (dialog.Getui().comboBox_4->currentIndex() == 0);
		compare.ascending[2] = (dialog.Getui().comboBox_6->currentIndex() == 0);
